...
edit1 e1=new edit1();
User_Bean u1=e1.get_values_of_user(name,pass);
%>
<div class="w3-top">
...
<div class="container">
  <form action="edit_con.jsp">
  <div class="row">
    <div class="col-25">
      <label for="fname">Full Name</label>
    </div>
    <div class="col-75">
      <input type="text" id="fname" name="fname" value="<%=u1.getName()%>" required >
    </div>
  </div>
  ...
  <div class="row">
    ...
    <option value="<%=u1.getBlood()%>">Default</option>
...
<div class="row">
    ...
    <div class="col-75">
<input type="text" name="date" placeholder="YYYY-MM-DD or NA if not applicable" required value="<%=u1.getDonation()%>"/>
        </div>
  </div>
<div class="row">
    <div class="col-25">
    ...
    <div class="col-75">
      <input type="tel" id="mob" name="mob" placeholder="Enter 10 Digit Mobile Number" pattern="[0-9]{10}" required value="<%=u1.getMob()%>">
    </div>
  </div>
  
 
      <input type="hidden" id="user" name="user" placeholder="Enter User Name.." required value="<%=name%>" readonly="readonly">
   
  
    
      <input type="hidden" id="pass" name="pass" placeholder="Enter Password.." required value="<%=pass%>" readonly="readonly">
